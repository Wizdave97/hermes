...
module.exports = {
    ...
    handleMessage(sender_psid, received_message) {
        ...
        if (received_message.text) {   
            ...
            if (number && number.confidence > 0.7 && command !== 'cancel') {
              ...
              if ((value && (String(value).lenghth >= 10 || String(value).length <= 13)) && previousCommand === 'phone') {
                ...
                callSendAPI(sender_psid, {text: 'You have Click the \'Proceed to checkout\' button on the persistent menu to proceed to checkout page'});
