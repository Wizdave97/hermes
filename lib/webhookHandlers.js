...
module.exports = {
    ...
    handleMessage(sender_psid, received_message) {
        ...
        if (received_message.text) {    
            ...
            if ((!number || (number && number.confidence < 0.8)) && previousPostback === 'cart')
            {
              callSendAPI(sender_psid, {text: 'Kindly type in a valid quantity'});
              return;
            }
            if ((!name || (name && name.confidence < 0.7)) && previousCommand === 'checkout') {
              callSendAPI(sender_psid, {text: 'Kindly type in a valid name'});
              return;
            }
            if ((!number || (number && number.confidence < 0.8)) && previousCommand === 'phone')
            {
            ...
            if (number && number.confidence > 0.8) {
              ...
              else if (value > 1000 && previousCommand === 'phone') {
            ...
            if (name && name.confidence > 0.75 && previousCommand === 'checkout') {
